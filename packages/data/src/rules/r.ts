export const RRules = [
  {
    ...
    ## Advanced Practices
    - Use S3/S4/S7 and R6 classes for complex objects.
  ...
  - 'glue' for string interpolation.
    ...
    Follow the official R, Tidyverse, and Bioconductor guidelines for best practices.
    `,
    author: {
      name: "Mohamed El Fodil Ihaddaden",
      url: "https://github.com/feddelegrand7",
      avatar: "https://avatars.githubusercontent.com/u/28841210?v=4", 
    },
  },
];
